...
//   return (
//     <section className="relative overflow-hidden bg-gradient-to-b from-black via-purple-950 to-blue-950 text-gray-200">

//       {/* Glow Background Effects */}
//       <div className="absolute top-[-140px] left-[-140px] w-[420px] h-[420px] bg-purple-600/30 blur-[160px] rounded-full"></div>
//       <div className="absolute bottom-[-140px] right-[-140px] w-[420px] h-[420px] bg-blue-600/30 blur-[160px] rounded-full"></div>

//       <div className="max-w-7xl mx-auto px-6 py-28 text-center relative">

//         {/* Tagline */}
//         <p className="text-sm font-semibold tracking-wider text-purple-400 uppercase mb-6">
...
//             Effortlessly with Planify
//           </span>
//         </h1>

//         {/* Description */}
//         <p className="mt-6 text-lg text-gray-400 max-w-2xl mx-auto leading-relaxed">
//           Planify helps you manage daily tasks, track productivity,
//           and stay focused. Built with modern technology to keep your
...
//           <Link
//             href="/auth/login"
//             className="px-8 py-3 rounded-lg bg-gradient-to-r from-purple-600 to-blue-600 text-white font-semibold shadow-lg hover:opacity-90 transition"
//           >
//             Get Started
//           </Link>
...
//           <Link
//             href="/about"
//             className="px-8 py-3 rounded-lg border border-purple-800 text-gray-300 font-medium hover:border-purple-400 hover:text-purple-400 transition"
//           >
//             Learn More
//           </Link>
...
//           <div className="bg-black/40 backdrop-blur-xl shadow-2xl rounded-2xl p-6 w-[340px] border border-purple-900/40">
