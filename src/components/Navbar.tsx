...
//   return (
//     <header className="w-full sticky top-0 z-50 backdrop-blur-md bg-white/70 border-b border-purple-100">
//       <nav className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">

//         {/* Logo */}
//         <Link href="/" className="text-2xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent tracking-tight">
//           Planify
//         </Link>
...
//           <Link
//             href="/auth/login"
//             className="px-5 py-2 rounded-lg bg-gradient-to-r from-purple-600 to-blue-600 text-white font-medium shadow-md hover:opacity-90 transition"
//           >
//             Login
//           </Link>
//         </div>
...
//             <Link
//               href="/login"
//               className="px-6 py-2 rounded-lg bg-gradient-to-r from-purple-600 to-blue-600 text-white font-medium shadow-md"
//             >
//               Login
//             </Link>
